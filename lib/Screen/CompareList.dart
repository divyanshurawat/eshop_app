...
class _CompareListState extends State<CompareList> {
  ...
  _returnable(String? returnable) {
    ...
    return Padding(
      ...
      child: Row(
        children: [
          Expanded(child: Text( getTranslated(context, 'RETURNABLE')!,
  ...
  _cancleable(String? pos) {
    return Padding(
      padding: const EdgeInsetsDirectional.only(start: 5.0,end: 5.0,bottom: 10.0),
      child: Row(
        children: [
          Expanded(child: Text(getTranslated(context, 'CANCELLABLE')!,
            style: Theme.of(context).textTheme.subtitle2,
          ),
          ),
          Text(pos ?? '-',maxLines: 1,softWrap: true,overflow: TextOverflow.ellipsis),
        ],
      ),
    );
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          Expanded(child: Text(madeIn != '' && madeIn!.isNotEmpty ? madeIn : '-',maxLines: 1,softWrap: true,overflow: TextOverflow.ellipsis)),
        ],
      ),
    );
  }
