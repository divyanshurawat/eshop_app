            ...
            children: [
              ...
              Expanded(
                child: Stack(
                  ...
                  selector: (_, ProductDetailsProvider) => ProductDetailsProvider.saleSectionListType,),
          ...
          child: Row(
            ...
            children: [
              ...
              InkWell(
                ...
                onTap: () {
                  context.read<ProductDetailProvider>().setSaleSectionListType(!context.read<ProductDetailProvider>().saleSectionListType);
                  !context.read<ProductDetailProvider>().saleSectionListType ?  listViewIconController.reverse() : listViewIconController.forward();
                }
              ),
            ],
          ),
